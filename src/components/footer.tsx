...
const Footer = () => {
  ...
  return (
    <footer className="bg-white font-sans text-[#1F6464]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div className="max-w-7xl mx-auto px-[5%] py-8 lg:pt-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-3">
            ...
            {/* Divider */}
            <div className="h-px bg-[#CFEAEA] mb-4 lg:mb-2" />

            {/* Contact Info */}
            <div className="space-y-5 lg:space-y-2.5 text-sm">
              {/* Address */}
              <div>
                <p className="text-[0.82rem] text-[#4A8585] leading-relaxed m-0">
              ...
              {/* Customer Service */}
              <div>
                <p className="text-[0.75rem] font-bold uppercase tracking-widest text-[#1F6464] m-0 mb-1">
                  Layanan Mahasiswa
                </p>
                <p className="text-[0.82rem] text-[#4A8585] m-0">
                  Telp: (031) 8706369
                </p>
                <p className="text-[0.82rem] text-[#4A8585] m-0">
          ...
          <div className="lg:col-span-9 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:ml-24">
              {FOOTER_COLUMNS.map((column) => (
                <div key={column.id}>
                  <h4 className="text-[0.75rem] font-bold tracking-widest text-[#1F6464] mb-4 pb-2 inline-block border-b-2 border-[#5FBFBF]">
                    {column.title}
                  </h4>
            ...
            <div className="w-full lg:max-w-2xl lg:mt-6 lg:ml-22">
              <div className="rounded-full px-3 py-2 flex flex-row items-center justify-between gap-2 lg:pl-8 lg:py-3" style={{ background: '#3B9C9C' }}>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <a
                    ...
                    onMouseEnter={e => (e.currentTarget.style.background = '#5FBFBF')}
      ...
      {/* Bottom Bar */}
      <div className="bg-white border-t border-[#DCEEEE] text-center py-3.5 px-[5%]">
        <p className="text-[0.78rem] text-[#5D8E8E] m-0">
