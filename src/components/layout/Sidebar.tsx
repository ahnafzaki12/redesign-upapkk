...
import { CATEGORY, EDUCATIONS, LOCATIONS, DURATIONS, TYPE_OPTIONS, INDUSTRIES, PACKAGES } from '../../lib/constants'
        ...
        return (
            <div className="relative" ref={dropdownRef}>
                <button
                    ...
                    className="w-full flex items-center justify-between rounded-md border px-4 py-3 text-sm bg-white hover:bg-slate-50 transition-all duration-200 shadow-sm"
                    style={{
