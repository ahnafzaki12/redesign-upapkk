...
// ── Data Articles & Events ──────────────────────────────────────────────────
const articleData = [
  {
    id: 1,
    title: "Takut Dewasa, Tapi Tetap Melangkah",
    date: "20 Februari 2026",
    description: "Artikel inspiratif tentang bagaimana menghadapi ketakutan saat memasuki fase dewasa dengan penuh tanggung jawab.",
  ...
  },
  {
    ...
    description: "Memahami pentingnya nilai dan tanggung jawab dalam memulai perjalanan karir profesional.",
  ...
  },
  {
    ...
    date: "12 Februari 2026",
    description: "Refleksi mendalam tentang pentingnya kesabaran dalam menjalani perjalanan panjang kehidupan secara konsisten.",
  ...
  },
  {
    ...
    description: "Pembahasan nilai kepemimpinan yang membentuk karakter tangguh saat menghadapi tekanan dan tantangan kerja.",
  ...
  },
  {
    ...
    date: "28 Januari 2026",
    description: "Menempatkan ilmu sebagai amanah dan menjadikan teladan sebagai fondasi kontribusi nyata untuk masyarakat.",
  ...
  },
  {
    ...
    description: "Panduan praktis menentukan prioritas hidup agar tetap fokus pada tujuan pribadi dan profesional.",
...
export default function ArticlePage() {
  ...
  const filtered = articleData.filter((item) => {
    const matchTab = item.tag === activeTab;
