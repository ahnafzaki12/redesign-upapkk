...
import { CATEGORY, DURATIONS, EDUCATIONS, GREEN, GREEN_DARK, GREEN_LIGHT, LOCATIONS } from "../data/constants"
import DetailModal from "../components/DetailModal"
import MagangCard from "../components/JobCard"
        ...
        <div className="min-h-screen bg-gray-50">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="flex flex-wrap items-end justify-between gap-5 mb-8">
                        <div>
                            ...
                            >
                                Temukan program magang terbaik dari perusahaan ternama dan mulai bangun karir impianmu hari ini.
                            </p>
                        </div>
                        ...
                        <div className="flex gap-3">
                            {[
                                { n: jobsData.length, label: "Program" },
                                { n: jobsData.reduce((s, j) => s + j.vacancies, 0), label: "Posisi" },
                            ].map(({ n, label }) => (
                                <div
                                    key={label}
                    ...
                    <div className="flex items-center gap-3 bg-white rounded-2xl px-5 py-1.5 shadow-xl">
                        ...
                        <input
                            ...
                            placeholder="Cari program magang, perusahaan, atau kategori..."
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 pb-20" style={{ marginTop: -32 }}>
                ...
                <div className="bg-white rounded-2xl px-5 py-4 shadow-md mb-6 flex flex-wrap gap-3 items-center ">
                    ...
                    <SearchableDropdown value={duration} onChange={setDuration} options={DURATIONS} placeholder="Durasi" />
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
                    <p className="text-sm text-gray-500">
                        Menampilkan{" "}
                        <span className="font-semibold text-gray-800">{sorted.length}</span> program ·{" "}
                ...
                {sorted.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-24 text-gray-400">
                        ...
                        <p className="text-base font-semibold mb-2 text-gray-500">Tidak ada program ditemukan</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {sorted.map((job) => (
                            <MagangCard key={job.id} job={job} onClick={() => setSelectedJob(job)} />
                        ))}
                    </div>
                )}
            </main>
